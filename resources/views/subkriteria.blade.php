                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody>
                            @foreach ($subkriteria as $kriteria)
                                <tr class="bg-white">
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 border-b border-gray-300 text-gray-500">{{ $kriteria->id }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 border-b border-gray-300 text-gray-500">{{ $kriteria->kriteria->nama }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 border-b border-gray-300 text-gray-500">{{ $kriteria->nama }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 border-b border-gray-300 text-gray-500">{{ $kriteria->bobot }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
